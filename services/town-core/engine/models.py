...
class NPC(Base):
    ...
    traveling = Column(Integer, default=0, server_default='0')  # v2: 1 if NPC is between neighborhoods
    travel_destination = Column(String(32), nullable=True)       # v2: target neighborhood name
    neighborhood = Column(String(32), default="town_core", server_default="town_core")  # v2: current neighborhood
    created_at = Column(DateTime, default=_utcnow)
