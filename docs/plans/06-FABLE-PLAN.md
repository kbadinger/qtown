...
| **W0-2** | Fix AI-layer facade (`route()` contract) | §2.3, §4.1 | The 5 callers reading `.response`/`.model_used` (`npc.py:364,421`, `newspaper.py:242`, `anthem.py:276`, `quests.py:352`) get a real model response; a test proves a live call reaches each. |
